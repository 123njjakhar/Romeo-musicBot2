...
from Romeo.inline import menu_markup, song_download_markup, stream_markup, audio_markup
...
3.) **Add me to your group or type /userbotjoin to invite her.**
...
💡 **If you have a follow-up questions about this bot, you can tell it on my support chat here: @{GROUP_SUPPORT}***""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🔙 𝐁𝐚𝐜𝐤", callback_data="cbstart")]]
        ),
    )
...
🤷 » /repo - To get the repo of Romeo-musicBot 
