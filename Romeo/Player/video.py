...
from Romeo.config import ASSISTANT_NAME, BOT_USERNAME, IMG_1, IMG_2, IMG_6
from Romeo.inline import stream_markup, audio_markup
...
IMAGE_THUMBNAIL = "https://telegra.ph/file/b4c1b5ea6b35b09142a02.jpg"
        ...
        if replied.video or replied.document:
            ...
            if len(m.command) < 2:
                await m.reply_photo(
                    ...
                    [
                        [
                            InlineKeyboardButton("📣 𝐂𝐡𝐚𝐧𝐧𝐞𝐥", url=f"https://t.me/RomeoBot_OP"),
                            InlineKeyboardButton("👥 𝐒𝐮𝐩𝐩𝐨𝐫𝐭", url=f"https://t.me/Romeo_OP")
                        ],
                        [
